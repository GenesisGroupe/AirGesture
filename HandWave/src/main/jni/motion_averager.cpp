...
JNIEXPORT jobject JNICALL Java_edu_washington_cs_touchfreelibrary_sensors_CameraGestureSensor_DetectMovementPosition(
        JNIEnv *env, jobject,
...
JNIEXPORT jobject JNICALL Java_edu_washington_cs_touchfreelibrary_sensors_CameraGestureSensor_DetectMovementPosition(
    ...
    object = env->NewObject(cls, constructor, avg.x, avg.y, totalFraction, bottomRightFraction,
                            bottomLeftFraction, topRightFraction, topLeftFraction);
